(function (global, factory) {
	...
	(global = global || self, factory(global.Hamo = {}));
	...
	function useDebug() {
	  ...
	  var debug = react.useMemo(function () {
	    ...
	    var isDebug = href.includes('#debug') ||
	    // localhost:3000/#debug
	    href.includes('/_debug') ||
	    // localhost:3000/_debug
	    searchParams.has('debug') ||
	    // localhost:3000/?debug
	    process.env.NODE_ENV === 'development'; // localhost:3000

	    var isProduction = href.includes('#production') ||
	 ...
	 */
	function useFrame(callback, priority) {
	  if (priority === void 0) {
	    priority = 0;
	  }
	  react.useEffect(function () {
	    if (callback) {
	      a.add(callback, priority);
	      return function () {
	...
	function useIntersectionObserver(_temp, deps) {
	  ...
	  react.useEffect(function () {
	    if (!element) return;
	    var intersection = new IntersectionObserver(function (_ref2) {
	      var entry = _ref2[0];
	      if (lazy) {
	  ...
	  }, [element, root, rootMargin, threshold, lazy, once].concat(deps));
	...
	*/
	...
	function useResizeObserver(_temp, deps) {
	  var _ref = _temp === void 0 ? {} : _temp,
	    _ref$lazy = _ref.lazy,
	    lazy = _ref$lazy === void 0 ? false : _ref$lazy,
	    _ref$debounce = _ref.debounce,
	    debounceDelay = _ref$debounce === void 0 ? 500 : _ref$debounce,
	    _ref$box = _ref.box,
	    box = _ref$box === void 0 ? 'border-box' : _ref$box,
	    _ref$callback = _ref.callback,
	    callback = _ref$callback === void 0 ? function () {} : _ref$callback;
	  if (deps === void 0) {
	    deps = [];
	  ...
	  react.useEffect(function () {
	    if (!element) return;
	    var onResize = functionDebounce(function (_ref2) {
	      var entry = _ref2[0];
	      entryRef.current = entry;
	      callback(entry);
	      if (!lazy) {
	  ...
	  }, [element, lazy, debounceDelay, box].concat(deps));
	  var get = react.useCallback(function () {
	    return entryRef.current;
	  }, []);
	  return [setElement, lazy ? get : entry];
	...
	function addParentSticky(element) {
	  ...
	  if ((element == null ? void 0 : (_element$dataset = element.dataset) == null ? void 0 : _element$dataset.sticky) === 'true') {
	...
	function offsetTop(element, accumulator) {
	  if (accumulator === void 0) {
	    accumulator = 0;
	  }
	  var top = accumulator + element.offsetTop;
	  if (element.offsetParent) {
	...
	function offsetLeft(element, accumulator) {
	  if (accumulator === void 0) {
	    accumulator = 0;
	  }
	  var left = accumulator + element.offsetLeft;
	  if (element.offsetParent) {
	...
	function useRect(_temp, deps) {
	  var _ref = _temp === void 0 ? {} : _temp,
	    _ref$ignoreTransform = _ref.ignoreTransform,
	    ignoreTransform = _ref$ignoreTransform === void 0 ? false : _ref$ignoreTransform,
	    _ref$ignoreSticky = _ref.ignoreSticky,
	    ignoreSticky = _ref$ignoreSticky === void 0 ? true : _ref$ignoreSticky,
	    _ref$lazy = _ref.lazy,
	    lazy = _ref$lazy === void 0 ? false : _ref$lazy,
	    _ref$debounce = _ref.debounce,
	    debounceDelay = _ref$debounce === void 0 ? 500 : _ref$debounce,
	    _ref$resizeDebounce = _ref.resizeDebounce,
	    resizeDebounce = _ref$resizeDebounce === void 0 ? debounceDelay : _ref$resizeDebounce,
	    _ref$callback = _ref.callback,
	  ...
	  var _useResizeObserver = useResizeObserver({
	      ...
	      callback: function callback(entry) {
	        ...
	        var height = entry.borderBoxSize[0].blockSize;
	        rectRef.current.width = width;
	        rectRef.current.height = height;
	        _callback(rectRef.current);
	        if (!lazy) {
	    ...
	    }, [lazy, resizeDebounce].concat(deps)),
	    setResizeObserverElement = _useResizeObserver[0];

	  // resize if body height changes
	  react.useEffect(function () {
	    if (!element) return;
	    var onBodyResize = functionDebounce(function () {
	      var top, left;
	    ...
	    var resizeObserver = new ResizeObserver(onBodyResize);
	    resizeObserver.observe(document.body);
	    return function () {
	      resizeObserver.disconnect();
	      onBodyResize.cancel();
	    };
	  }, [element, lazy, debounceDelay, ignoreTransform, ignoreSticky].concat(deps));
	  var getRect = react.useCallback(function () {
	...
	function useSlots(types, children) {
	  if (types === void 0) {
	    types = [];
	  }
	  if (children === void 0) {
	  ...
	  var _children = react.useMemo(function () {
	    return children && [children].flat();
	  }, [children]);
	  var _types = react.useMemo(function () {
	  ...
	  var slots = react.useMemo(function () {
	    ...
	    var slots = _types.map(function (type) {
	      var _children$find;
	      return (_children$find = _children.find(function (el) {
	        return el.type === type;
	      })) == null ? void 0 : _children$find.props.children;
	    });
	...
	function useWindowSize(debounceDelay) {
	  ...
	  react.useEffect(function () {
	    var onWindowRezise = functionDebounce(function () {
	...
	exports.useDocumentReadyState = useDocumentReadyState;
	...
	exports.useOutsideClickEvent = useOutsideClickEvent;
